...
<div class="container-fluid page-header py-5 dynamic-header">
    <div class="container text-center py-5">
        ...
        <span class="text-white mb-4 animated slideInDown"><?php the_archive_description(); ?></span>
                    ...
                    <div class="col-lg-6 col-xl-4 wow fadeIn" data-wow-delay=".3s">
                        <div class="blog-item position-relative bg-light rounded">
                            ...
                            <div class="blog-coment d-flex justify-content-between px-4 py-2 border bg-primary rounded-bottom">
                                <a href="" class="text-white"><small><i class="fa fa-comments me-2 text-secondary"></i>Автор: <?php get_the_author_meta('firstname'); ?></small></a>
                            </div>
                        </div>
                    </div>
                <?php endwhile; ?>
